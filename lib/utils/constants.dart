...
const MaterialColor BUTTON_COLOR = const MaterialColor(
  0x8B8175,
  const <int, Color>{
    50: const Color(0x8B8175),
    100: const Color(0x8B8175),
    200: const Color(0x8B8175),
    300: const Color(0x8B8175),
    400: const Color(0x8B8175),
    500: const Color(0x8B8175),
    600: const Color(0x8B8175),
    700: const Color(0x8B8175),
    800: const Color(0x8B8175),
    900: const Color(0x8B8175),
  },
);
